...
const A3 = [0, 0, 2.659, 1.954, 1.628, 1.427, 1.287, 1.182, 1.099, 1.032, 0.975, 0.927, 0.886, 0.850, 0.817, 0.789]
const D3 = [0, 0, 0,     0,     0,     0,     0,     0.076, 0.136, 0.184, 0.223]
const D4 = [0, 0, 3.267, 2.575, 2.282, 2.115, 2.004, 1.924, 1.864, 1.816, 1.777]
const B3 = [0, 0, 0,     0,     0,     0,     0.030, 0.118, 0.185, 0.239, 0.284, 0.321, 0.354, 0.382, 0.406, 0.428]
const B4 = [0, 0, 3.267, 2.568, 2.266, 2.089, 1.970, 1.882, 1.815, 1.761, 1.716, 1.679, 1.646, 1.618, 1.594, 1.572]
...
const variance = (arr, ddof = 0) => {
  let mean = avg(arr)
  return avg(arr.map( x => Math.pow(x - mean, 2)), ddof)
}
